    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if torch.distributed.get_rank() == 0:
                # Master process
                gathered_grads = [[torch.zeros_like(param.grad.data), torch.zeros_like(param.grad.data), torch.zeros_like(param.grad.data), torch.zeros_like(param.grad.data)] for param in model.parameters()]
                ...
                # Average gradients
                if torch.distributed.get_rank() == 0:
                    print(f"Rank {torch.distributed.get_rank()} is averaging gradients")
